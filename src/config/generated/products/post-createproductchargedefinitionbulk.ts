...
export const post_createproductchargedefinitionbulkEndpoint: ApiEndpoint = {
  "id": "post-createproductchargedefinitionbulk",
  "name": "Create product charge definitions",
  "description": "",
  "method": "POST",
